...
function ModalAdicionarAoPortfolio({ projeto, onClose, onSave }) {
  ...
  const handleFrameworkKeyDown = (e) => {
    if (e.key === 'Enter') {
      e.preventDefault() // <--- TRAVA O ENTER
      addFramework()
    }
  }
            ...
            <div className="form-group upload-box">
              ...
              <div className="file-input-wrapper">
                <input
                  ...
                  disabled={loading}
                />
                <label htmlFor="capa-input" className={`btn-upload ${loading ? 'disabled' : ''}`}>
            ...
            <div className="form-group upload-box">
              ...
              <div className="file-input-wrapper">
                <input
                  ...
                  disabled={loading}
                />
                <label htmlFor="pdf-input" className={`btn-upload secondary ${loading ? 'disabled' : ''}`}>
            ...
            <div className="form-group upload-box">
              ...
              <div className="file-input-wrapper">
                <input
                  ...
                  disabled={loading}
                />
                <label htmlFor="mobile-input" className={`btn-upload secondary ${loading ? 'disabled' : ''}`}>
                  {formData.imagensMobile.length > 0 
                    ? `${formData.imagensMobile.length} arquivos` 
                    : 'Selecionar Mobile'}
                </label>
              </div>
            </div>
            ...
            <div className="form-group upload-box">
              ...
              <div className="file-input-wrapper">
                <input
                  ...
                  disabled={loading}
                />
                <label htmlFor="desktop-input" className={`btn-upload secondary ${loading ? 'disabled' : ''}`}>
                  {formData.imagensDesktop.length > 0 
                    ? `${formData.imagensDesktop.length} arquivos` 
                    : 'Selecionar Desktop'}
                </label>
              </div>
            </div>
...
export default ModalAdicionarAoPortfolio